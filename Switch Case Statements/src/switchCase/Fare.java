...
public class Fare 
{
	public static void main(String[] args)
	{
		...
		answer = in.next();                              //answer must be stored in upper case so:
		...
		switch (rightCode)
			{
			case "Yes":
				System.out.println("\nDiscount: \t\t\t\t" + d.format(discount));
				System.out.println("Business class charge: \t\t" + d.format(charge) );
				System.out.println("New Fare: \t\t\t\t" + d.format(fare - discount + charge));
				System.out.println("\nEnd of Transaction :-)");
			break;
			case "No":
				System.out.println("\n"+0);	//this makes all output 0 if there is a wrong code
			}
		//Done!
